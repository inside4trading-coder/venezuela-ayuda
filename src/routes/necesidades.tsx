...
function NeedsPage() {
  ...
  const critical = centers.filter((c) => c.necesita.some((n) => n.nivel === "critico"));
    ...
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-8 lg:py-12 space-y-10">
      ...
      <section>
        ...
        {isLoading ? (
          ...
          <p className="text-[14px] text-[var(--color-text-muted)]">No hay centros con necesidades críticas registradas.</p>
        ) : (
